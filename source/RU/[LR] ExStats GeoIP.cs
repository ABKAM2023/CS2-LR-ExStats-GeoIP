...
{
    public override string ModuleName => "[Levels Ranks] ExStats GeoIP";
    ...
    private async Task LogPlayerConnectionAsync(string steamId, string playerIp)
    {
        try
        {
            ...
            var countryName = cityResponse.Country.Names.ContainsKey("ru") ? cityResponse.Country.Names["ru"] : cityResponse.Country.Names["en"];
            var regionName = cityResponse.MostSpecificSubdivision.Names.ContainsKey("ru") ? cityResponse.MostSpecificSubdivision.Names["ru"] : cityResponse.MostSpecificSubdivision.Names["en"];
            var cityName = cityResponse.City.Names.ContainsKey("ru") ? cityResponse.City.Names["ru"] : cityResponse.City.Names["en"];
